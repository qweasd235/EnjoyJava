...
public class Array04 {
    public static void main(String[] args) {
        ...
        array1[2] = new ItemForArray(800, "수박");

        ItemForArray[] array2 = new ItemForArray[]{new ItemForArray(500,"사과"), new ItemForArray(300, "바나나"), new ItemForArray(800,"수박")};
        ItemForArray[] array3 = new ItemForArray[]{new ItemForArray(500,"사과"), new ItemForArray(300, "바나나"), new ItemForArray(800,"수박")};
