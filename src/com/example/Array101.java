...
public class Array101 {
    public static void main(String[] args) {
        ...
        items[3] = new Item("c++", 2000);
        items[4] = new Item("javaScript", 5000);

        //sort(Object[]) - Object는 모든 객체의 조상이니 어떤 객체의 배열이든 올 수 있다.
 //       Arrays.sort(items, new ItemSortor());
...
class ItemSortor implements Comparator{
    // o1 - o2
    @Override
...
class Item implements Comparable{
    ...
    // 파라미터로 들어온 Object의 내 자신을 비교하는 메소드
    // compareTo에는 Object를 받아들이도록 했지만 실제는 Item이 들어온다.
    // 홍길동, 고길동
    @Override
